      ...
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-12 gap-12 items-start relative z-10">
        ...
        >
          ...
          <motion.div className="flex justify-start mb-4" variants={textRevealVariants}>
            <div className="glass-panel px-5 py-2 rounded-full flex items-center gap-3 border border-orange-500/30 shadow-[0_0_20px_rgba(249,115,22,0.2)] bg-[#030014]/50 backdrop-blur-md">
              <motion.div 
                className="w-2.5 h-2.5 rounded-full bg-orange-400 shadow-[0_0_10px_rgba(249,115,22,1)]"
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
            >
              <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-orange-200 via-white to-red-200 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          ...
          >
            <a href="https://github.com/RIDAs-24" target="_blank" rel="noopener noreferrer" className="group relative">
              <div className="absolute inset-0 bg-orange-500 rounded-full blur opacity-0 group-hover:opacity-60 transition-opacity duration-300" />
            ...
            <a href="https://linkedin.com/in/" target="_blank" rel="noopener noreferrer" className="group relative">
              <div className="absolute inset-0 bg-red-500 rounded-full blur opacity-0 group-hover:opacity-60 transition-opacity duration-300" />
              <div className="relative p-3 bg-white/5 border border-white/10 rounded-full hover:bg-white/10 transition-colors">
                <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current text-slate-300 group-hover:text-white transition-colors">
            ...
            <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" className="group relative">
              <div className="absolute inset-0 bg-purple-500 rounded-full blur opacity-0 group-hover:opacity-60 transition-opacity duration-300" />
              <div className="relative p-3 bg-white/5 border border-white/10 rounded-full hover:bg-white/10 transition-colors">
                <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current text-slate-300 group-hover:text-white transition-colors">
