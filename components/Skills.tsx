...
export default function Skills() {
  return (
    <section id="skills" className="py-32 px-6 relative z-10 overflow-hidden min-h-screen flex items-center">
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-16 lg:gap-8 items-center">
        ...
        <motion.div 
          className="relative h-[600px] lg:h-[800px] w-full flex items-center justify-center lg:sticky lg:top-20"
